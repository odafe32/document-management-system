            ...
            <div class="announcements-list">
                    ...
                    <div class="announcement-item">
                        <div class="announcement-header">
                            ...
                            <div class="announcement-meta">
                                <span><i class="fas fa-user"></i> {{ $announcement->user->name ?? 'Admin' }}</span>
                        ...
                        <div class="announcement-body">
                            <div class="announcement-content">
                                {{ Str::limit(strip_tags($announcement->body), 300) }}
                                @if(strlen(strip_tags($announcement->body)) > 300)
                                    <a href="{{ route('student.announcements.view', $announcement) }}" style="color: #3b82f6;">Read more...</a>
                                @endif
                            </div>
                            ...
                            @if($announcement->attachment)
                                <div class="attachment-info">
                                    ...
                                    <a href="{{ route('student.announcements.download', $announcement) }}" class="btn-secondary" style="margin-left: auto;">
                            ...
                            <div class="announcement-actions">
                                <a href="{{ route('student.announcements.view', $announcement) }}" class="btn-primary">
                ...
                @empty
                    <div class="empty-state">
                        ...
                        <p>There are no announcements available for your department at the moment.</p>
                    </div>
                @endforelse
