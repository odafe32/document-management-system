...
<div class="edit-container">
    <div class="edit-wrapper">
        ...
        <div class="page-header">
            <div class="page-header-content">
                ...
                <a href="{{ route('staff.documents') }}" class="btn-secondary">
        ...
        <form action="{{ route('staff.documents.update', $document) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
    ...
    <p class="help-text">Leave empty to show announcement to all departments, or select a specific department</p>
                ...
                <div class="card-content">
                    ...
                    <div class="current-file">
                        ...
                        <div style="margin-left: auto;">
                            <a href="{{ route('staff.documents.download', $document) }}" class="btn-secondary">
            ...
            <div class="form-actions">
                <a href="{{ route('staff.documents') }}" class="btn-gray">
