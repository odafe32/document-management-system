    ...
    <div class="announcements-wrapper">
        ...
        <div class="page-header">
            <div class="page-header-content">
                ...
                <a href="{{ route('staff.announcements.create') }}" class="btn-primary">
                ...
                <div class="announcements-list">
                        ...
                        <div class="announcement-item">
                            <div class="announcement-header">
                                <div style="flex: 1;">
                                    ...
                                    <div class="announcement-meta">
                                        <span class="category-badge">{{ $announcement->category_display }}</span>
                                        <span class="visibility-badge">{{ $announcement->visibility_display }}</span>
                                        ...
                                        @if($announcement->expiry_date)
                                            <span><i class="fas fa-calendar-times"></i> Expires {{ $announcement->expiry_date->format('M j, Y') }}</span>
                                        @endif
                                    </div>
                                </div>
                                
                                <div class="announcement-actions">
                                    <a href="{{ route('staff.announcements.edit', $announcement) }}" class="btn-success" title="Edit">
                            ...
                            <div class="announcement-body">
                                <div class="announcement-content">
                                    {{ Str::limit($announcement->body, 300) }}
                                    @if(strlen($announcement->body) > 300)
                                        <a href="{{ route('staff.announcements.edit', $announcement) }}" style="color: #3b82f6;">Read more...</a>
                                    @endif
                                </div>
                                ...
                                @if($announcement->attachment)
                                    <div class="attachment-info">
                                        ...
                                        <a href="{{ route('staff.announcements.download', $announcement) }}" class="btn-secondary" style="margin-left: auto;">
                    ...
                    @empty
                        <div class="empty-state">
                            ...
                            <a href="{{ route('staff.announcements.create') }}" class="btn-primary" style="background: darkgreen; margin-top: 1rem;">
                                <i class="fas fa-plus"></i>Create Announcement
                            </a>
                        </div>
                    @endforelse
            ...
            <div class="sidebar">
                ...
                <div class="sidebar-card">
                    ...
                    <div class="sidebar-content">
                        <a href="{{ route('staff.announcements.create') }}" class="btn-primary" style="width: 100%; margin-bottom: 1rem; background: darkgreen; justify-content: center;">
                            <i class="fas fa-plus"></i>Create Announcement
                        </a>
                        <a href="{{ route('staff.announcements') }}" class="btn-secondary" style="width: 100%; justify-content: center;">
                ...
                <div class="sidebar-card">
                    ...
                    <div class="sidebar-content">
                        <div style="font-size: 0.875rem; color: #6b7280; line-height: 1.6;">
                            ...
                            <p><strong>Timetable:</strong> Schedule changes</p>
...
<script>
    ...
    function confirmDelete(announcementId, announcementTitle) {
        ...
        document.getElementById('deleteForm').action = `/staff/announcements/${announcementId}`;
