        ...
        <div class="page-header">
            <div class="page-header-content">
                <div class="page-title">
                    ...
                    <h1 style="color: #fff;">Edit Announcement</h1>
                </div>
                    ...
                    <div style="background: #f8fafc; border-radius: 8px; padding: 1rem; margin-bottom: 1.5rem;">
                        <div style="display: flex; gap: 1rem; align-items: center; margin-bottom: 0.5rem;">
                            <span class="staff-badge">
                                <i class="fas fa-user"></i> Created by: {{ $announcement->user->name ?? 'Unknown' }}
                            </span>
                            <span style="font-size: 0.875rem; color: #6b7280;">
                                <i class="fas fa-clock"></i> {{ $announcement->created_at->format('M d, Y \a\t g:i A') }}
                            </span>
                            <span style="font-size: 0.875rem; color: #6b7280;">
                        ...
                        @if($announcement->updated_at != $announcement->created_at)
                            <div style="font-size: 0.875rem; color: #6b7280;">
                                <i class="fas fa-edit"></i> Last updated: {{ $announcement->updated_at->diffForHumans() }}
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="card-content">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="body" class="form-control @error('body') error @enderror" 
                                  rows="8" required placeholder="Write your announcement content here...">{{ old('body', $announcement->body) }}</textarea>
                        @error('body')
                            <p class="text-error">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            @error('category')
                                <p class="text-error">{{ $message }}</p>
                            @enderror
                        </div><!-- Add this field to your announcement create/edit forms -->
<div class="form-group">
    <label class="form-label">
    ...
    <p class="help-text">Leave empty to show announcement to all departments, or select a specific department</p>
                    ...
                    <div class="form-group">
                        ...
                        <p class="help-text">Uncheck to deactivate this announcement</p>
                    </div>
                </div>
            </div>
                ...
                <div class="card-content">
                        ...
                        <div class="current-attachment">
                            ...
                            <div class="attachment-info">
                                ...
                                <div class="attachment-meta">
                                    <span><i class="fas fa-clock"></i> Uploaded {{ $announcement->created_at->diffForHumans() }}</span>
                                </div>
                            </div>
                            <div style="margin-left: auto;">
                                <a href="{{ route('admin.announcements.download', $announcement) }}" class="btn-secondary">
                    ...
                    <div class="form-group">
                        <label class="form-label">
                            ...
                            {{ $announcement->attachment ? 'Replace Attachment (Optional)' : 'Add Attachment (Optional)' }}
                        </label>
                        <p style="font-size: 0.875rem; color: #6b7280; margin-bottom: 1rem;">
                            {{ $announcement->attachment ? 'Leave empty to keep current attachment. Upload a new file to replace it.' : 'You can attach a file to your announcement' }}
